...
public class SitePedestal : Site
{
    ...
    public SitePedestalPanel sitePanel;
    ...
    public void UpdateIcons()
    {
        ...
        if(siteInventory.contents[0, 0] != null){
            displaySprite.sprite = siteInventory.contents[0, 0].item.icon;
        } else{
